...
class Project extends \AppBundle\Entity\Project implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Project' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Project' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Project' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Project' . "\0" . 'dueDate', '' . "\0" . 'AppBundle\\Entity\\Project' . "\0" . 'workspace'];
        }
